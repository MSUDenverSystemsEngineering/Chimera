...
Try {
	...
	[string]$appScriptDate = '02/06/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-Process -Path "$dirFiles/chimera-1.13.1-win64.exe" -Parameters '/verysilent /log=chimerauninstall.log' -WindowStyle 'Hidden' -WaitForMsiExec:$true
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envProgramFiles/Chimera 1.13.1/unins000.exe" -Parameters '/verysilent /log=chimera.log' -WindowStyle 'Hidden' -WaitForMsiExec:$true
